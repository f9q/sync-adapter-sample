...
//        long groupId = ContactManager.ensureSampleGroupExists(context, accountName);
    ...
    /**
     * updateContact for local update
     * @param context
     * @param resolver
     * @param rawContact
     * @param rawContactId
     */
    public static void updateContactLocal(Context context, ContentResolver resolver,
                                     RawContact rawContact, long rawContactId){
        final BatchOperation batchOperation = new BatchOperation(context, resolver);
        updateContact(context, resolver, rawContact, false, false, false,false, rawContactId, batchOperation);
        batchOperation.execute();
    }
    ...
    public static void updateContact(Context context, ContentResolver resolver,
        ...
        //TODO perfermance opti  for updateAvater never being used.
