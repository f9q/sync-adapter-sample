...
/**
 * A sign up screen that offers sign via name/email/password.
 */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==android.R.id.home){
            ...
            if(flag==true) {
                ...
                Toast.makeText(SignUpActivity.this,"Sign up error, Please wait for a moment and sign up again!",Toast.LENGTH_SHORT).show();
            }
        }
